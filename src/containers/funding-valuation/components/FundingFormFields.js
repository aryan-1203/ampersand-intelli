    ...
    <div>
        <FormGroup className="form-group">
            ...
            <div className="custom-select-wrapper">
                <select
                    id="stage"
                    className={`form-control ${formik.errors.stage ? "border-danger" : ""
                        }`}
                    name="stage"
        ...
        <FormGroup className="form-group">
            ...
            <div className="d-flex align-items-start" style={{ gap: "5px" }}>
                ...
                >
                    <input
                        className={`form-control ${formik.errors.amountRaised ? "border-danger" : ""
                            }`}
                        id="amountRaised"
                        type="text"
        ...
        <div className="grid-container">
            <FormGroup className="form-group">
                ...
                <div className="d-flex align-items-start" style={{ gap: "5px" }}>
                    ...
                    >
                        <input
                            className={`form-control ${formik.errors.lastValuation ? "border-danger" : ""
                                }`}
                            id="lastValuation"
                            type="text"
                            placeholder="1.4"
            ...
            <FormGroup className="form-group">
                ...
                <div className="d-flex align-items-start" style={{ gap: "5px" }}>
                    ...
                    >
                        <input
                            className={`form-control ${formik.errors.currentValuation ? "border-danger" : ""
                                }`}
                            id="currentValuation"
                            type="text"
                            placeholder="1.4"
        ...
        <FormGroup className="form-group">
            ...
            <div className="d-flex align-items-start" style={{ gap: "5px" }}>
                ...
                >
                    <input
                        className={`form-control ${formik.errors.capitalRequirements ? "border-danger" : ""
                            }`}
